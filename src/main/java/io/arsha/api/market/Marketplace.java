    ...
    private static JsonObject parseRequest(V1Composite request) {
        ...
        switch (requestId) {
            ...
            case GetWorldMarketList:
                requestBody.put("keyType", 0).put("mainCategory", Integer.valueOf(arg1)).put("subCategory", Integer.valueOf(arg2));
                break;  
            case GetWorldMarketSubList:
                requestBody.put("keyType", 0).put("mainKey", Integer.valueOf(arg1));
                break;
            case GetWorldMarketSearchList:
                requestBody.put("searchResult", arg1);
                break;
            case GetBiddingInfoList:
                requestBody.put("keyType", 0).put("mainKey", Integer.valueOf(arg1)).put("subKey", Integer.valueOf(arg2));
                break;  
