...
public class Mongo {
    ...
    public static Future<Void> init(Vertx vertx) {
        ...
        Util.read("conf/mongo.json").onSuccess(mongoConf -> { 
            ...
            JsonObject itemConfig = new JsonObject().put("connection_string", connection).put("db_name", "items");
            JsonObject recipeConfig = new JsonObject().put("connection_string", connection).put("db_name", "recipes");
     ...
     * @return           <code>Future</code> with result <code>List&lt;JsonObject&gt;</code> if found otherwise null
     */
     ...
     * @return           <code>Future</code> with result <code>JsonObject</code> if found otherwise null
     */
